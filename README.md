...
[**Find PI to the Nth Digit**](https://github.com/victorman/Projects/blob/master/Numbers/Pi.pl) – Enter a number and have the program generate PI up to that many decimal places. Keep a limit to how far the program will go.

[**Fibonacci Sequence**](https://github.com/victorman/Projects/blob/master/Numbers/Fibonacci.pl) – Enter a number and have the program generate the Fibonacci sequence to that number or to the Nth number.

[**Prime Factorization**](https://github.com/victorman/Projects/blob/master/Numbers/PrimeFactors.pl) – Have the user enter a number and find all Prime Factors (if there are any) and display them.

[**Next Prime Number**](https://github.com/victorman/Projects/blob/master/Numbers/Primes.pl) – Have the program find prime numbers until the user chooses to stop asking for the next one.

[**Find Cost of Tile to Cover W x H Floor**](https://github.com/victorman/Projects/blob/master/Numbers/Tile.pl) – Calculate the total cost of tile it would take to cover a floor plan of width and height, using a cost entered by the user.

[**Mortgage Calculator**](https://github.com/victorman/Projects/blob/master/Numbers/Mortgage.pl) – Calculate the monthly payments of a fixed term mortgage over given Nth terms at a given interest rate. Also figure out how long it will take the user to pay back the loan.
